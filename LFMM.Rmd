...
tiff( "manhattan_PC1.png", units="in", width=8, height=4, res=400)
...
tiff( "manhattan_PC2.png", units="in", width=8, height=4, res=400)
...
#For weather heterogeneity
mod.PC3 <- LEA::lfmm2(input = df_clean, env = weather_PC1, K = 3)
pv.PC3 <-lfmm2.test(object = mod.PC3, input = df_clean, env = weather_PC1, linear = TRUE)
...
tiff( "manhattan_PC3.png", units="in", width=8, height=4, res=400)
...
qq(pv.host$pvalues)
tiff( "manhattan_host.png", units="in", width=8, height=4, res=400)
