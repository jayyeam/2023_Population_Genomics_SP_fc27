...
write.table(outliers_pcadapt, file = "Outloci_pos_pcadapt.csv", append =FALSE, sep = " ", dec = ".", row.names = TRUE, col.names = TRUE)
...
Outliers_pcadapt_gff <- read.delim("/Users/jyeam/Documents/Projects/2022_Population_Genomics/Files/Outloci_pcadapt.gff", header=F, comment.char="#")
